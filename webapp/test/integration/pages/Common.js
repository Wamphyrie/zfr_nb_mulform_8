sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("phoenix/app", ".html");
			sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

			if (sHash) {
				sHash = "#Sendingmultiplevaluestoformatterfunction-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
			} else {
				sHash = "#Sendingmultiplevaluestoformatterfunction-display";
			}

			return sUrl + sUrlParameters + sHash;
		}

		return Opa5.extend("phoenix.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["phoenix/localService/mockserver"], function (mockserver) {
